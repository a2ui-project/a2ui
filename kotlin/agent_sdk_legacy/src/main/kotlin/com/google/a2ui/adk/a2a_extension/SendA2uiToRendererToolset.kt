 ...
 * demand.
 */
class SendA2uiToRendererToolset
@JvmOverloads
constructor(
  ...
  private val logger = Logger.getLogger(SendA2uiToRendererToolset::class.java.name)
  private val uiTools = listOf(SendA2uiJsonToRendererTool())
  ...
  inner class SendA2uiJsonToRendererTool :
    BaseTool(
      TOOL_NAME,
      "Sends A2UI JSON to the renderer to render rich UI natively. Always prefer this over returning raw JSON.",
    ) {
                ...
                mapOf(
                  A2UI_JSON_ARG_NAME to
                    Schema.builder()
                      ...
                      .description("The A2UI JSON payload to send to the renderer.")
                      .build()
                )
              )
              .build()
  ...
  companion object {
    ...
    fun create(
      ...
      catalog: A2uiCatalog,
      examples: String = "",
    ): SendA2uiToRendererToolset = SendA2uiToRendererToolset({ enabled }, { catalog }, { examples })

    const val TOOL_NAME = "send_a2ui_json_to_renderer"
