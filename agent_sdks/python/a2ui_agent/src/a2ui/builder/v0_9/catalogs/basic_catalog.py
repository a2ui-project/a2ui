...
from typing import Annotated, Any, Mapping, Literal, Optional, Sequence
...
class FormatString(FunctionCall):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(
            call="formatString", args={"value": value}, **kwargs
        )
...
class FormatNumber(FunctionCall):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(
            call="formatNumber", args=args, **kwargs
        )
...
def format_number(
    *,
    ...
    r"""Invokes catalog function formatNumber."""
    return FormatNumber(
        value=value, decimals=decimals, grouping=grouping,
    )
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if grouping is not None:
            args["grouping"] = grouping
        super().__init__(
            call="formatCurrency", args=args, **kwargs
        )
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if many is not None:
            args["many"] = many
        super().__init__(
            call="pluralize", args=args, **kwargs
        )
...
class OpenUrl(FunctionCall):
    ...
    def __init__(
        ...
        super().__init__(
            call="openUrl", args={"url": url}, **kwargs
        )
...
class And(FunctionCall):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(
            call="and", args={"values": values}, **kwargs
        )
...
class Or(FunctionCall):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(
            call="or", args={"values": values}, **kwargs
        )
...
class Not(FunctionCall):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(
            call="not", args={"value": value}, **kwargs
        )
