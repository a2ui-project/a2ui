...
- **`processor.py`**: `TemplateProcessor` for generating synthetic inference catalogs and expanding template invocations into Basic Catalog primitives.
