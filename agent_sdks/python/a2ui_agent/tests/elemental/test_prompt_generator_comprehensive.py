...
"""Comprehensive unit tests for ElementalPromptGenerator."""
...
class TestElementalPromptGeneratorComprehensive(unittest.TestCase):
    def setUp(self):
        # Build a rich catalog testing all mapping branches of _map_schema_to_ts_type
    ...
    def test_allowed_components_pruning(self):
        ...
        # Only allow checks/pruning of Text components (which aren't in this catalog, but will prune RichComponent)
        prompt = generator.generate(
            role_description="Test role",
            include_schema=True,
    ...
    def test_elemental_include_examples_transformation(self):
        ...
        # Initialize ElementalFormat with examples.md path
        ...
        # Verify examples are included and decompiled to HTML
    ...
    def test_elemental_examples_validation(self):
        ...
        # Initialize ElementalFormat with directory path
        elemental_format = ElementalFormat(
