                ...
                'surfaceUpdate': {
                    ...
                    'components': [
                        ...
                        },
                        {
                            ...
                            'component': {
                                'Text': {'text': {'literalString': 'Calendar'}}
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            'component': {
                                'Text': {'text': {'literalString': 'Location'}}
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            'component': {
                                'Text': {'text': {'literalString': 'Mobile'}}
                            },
                        },
                        {
                            'id': 'call_text_column',
                        ...
                        },
                        {
                            'id': 'button_1_text',
                            'component': {
                                'Text': {'text': {'literalString': 'Follow'}}
                            },
                        },
                        {
                            'id': 'button_1',
                        ...
                        },
                        {
                            'id': 'button_2_text',
                            'component': {
                                'Text': {'text': {'literalString': 'Message'}}
                            },
                        },
                        {
                            'id': 'button_2',
                        ...
                        },
                        {
                            ...
                            'component': {
                                'Row': {
                                    'children': {
                                        'explicitList': ['button_1', 'button_2']
                                    },
                                    'distribution': 'center',
                                    'alignment': 'center',
                                }
