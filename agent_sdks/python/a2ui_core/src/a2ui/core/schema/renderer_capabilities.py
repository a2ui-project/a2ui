...
class V1_0Capabilities(StrictBaseModel):
    supported_catalog_ids: List[str] = Field(
        ...
        description=(
            ...
            " catalogs supported by the renderer."
        ),
    )
    inline_catalogs: Optional[List[Any]] = Field(
        None,
...
class A2uiRendererCapabilities(StrictBaseModel):
    v1_0: Optional[V1_0Capabilities] = Field(None, alias=SPEC_VERSION)
