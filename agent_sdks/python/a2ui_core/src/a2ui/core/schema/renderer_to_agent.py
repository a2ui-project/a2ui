...
class A2uiRendererAction(StrictBaseModel):
    ...
    action_id: Optional[str] = Field(
        ...
        alias="actionId",
        description=(
            "Unique ID for this action call. Only needed if wantResponse is true."
        ),
    )
...
A2uiRendererMessageList = List[A2uiRendererMessage]


class A2uiRendererMessageListWrapper(StrictBaseModel):
    messages: A2uiRendererMessageList = Field(
