...
3. Run [release.sh](../../python/release.sh) from the `python` directory. It builds the package, uploads it to the Artifact Registry, and triggers the release pipeline.
