...
> Version 0.8 is a legacy release, maintained for backward compatibility. For production use, consider [v0.9.1 (Current)](v0.9.1-a2ui.md).
...
- [v0.9 Protocol Specification](v0.9-a2ui.md) (Previous Stable, superseded by [v0.9.1](v0.9.1-a2ui.md)).
