...
1. **Programmatic validation ([a2ui_scorer](../../eval/a2ui_eval/scorers.py))**:
    ...
    - Runs the catalog validator ([validate_components](../../python/a2ui_agent/README.md)) to verify schema adherence, parent-child references, and root component presence.
