...
- A running web app with A2UI Flutter renderer.
...
- **Flutter** [Install here](https://docs.flutter.dev/install)
...
- Review the [samples/client/flutter/README.md](../samples/client/flutter)
