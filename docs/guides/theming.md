...
- See the schema definition in [server-to-client.ts](../../adapters/web_core/src/v0_9/schema/server-to-client.ts).
- See the `Catalog` class and `themeSchema` in [catalog/types.ts](../../adapters/web_core/src/v0_9/catalog/types.ts).
...
See the default styles in [default.ts](../../adapters/web_core/src/v0_9/basic_catalog/styles/default.ts).
