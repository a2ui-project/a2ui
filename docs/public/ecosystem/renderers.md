...
| **metabindai/a2ui-bindjs**                                         | React, SwiftUI, Jetpack Compose       | ❌   | ✅   | ![Stars](https://img.shields.io/github/stars/metabindai/a2ui-bindjs?style=flat-square&label=⭐) ![Last commit](https://img.shields.io/github/last-commit/metabindai/a2ui-bindjs?style=flat-square&label=updated)                              | [GitHub](https://github.com/metabindai/a2ui-bindjs) · [npm](https://www.npmjs.com/package/@metabindai/a2ui-bindjs-react) · [Docs](https://docs.metabind.ai/bindjs/introduction)                 |
...
**metabindai/a2ui-bindjs** (`@metabindai/a2ui-bindjs-react`) is an A2UI renderer supporting v0.9.1 and the v1.0 Candidate spec, built on [BindJS](https://docs.metabind.ai/bindjs/introduction), an open component language for defining UI once and rendering it natively across platforms.

BindJS components are written in JavaScript using a SwiftUI-shaped API and compiled into a view tree rendered with each platform's native UI framework: React on the web, SwiftUI on Apple platforms, and Jetpack Compose on Android.

For A2UI, this means a catalog can have a single BindJS implementation shared across all three platforms. The full Basic Catalog is implemented this way, and custom components work the same way: write one BindJS component, add it to the catalog, and it renders everywhere without per-platform renderer code. Hosts can also load updated catalogs at runtime without requiring an app release.

BindJS and the renderer are Apache-2.0 licensed.
