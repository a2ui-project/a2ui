...
**See working example:** [Angular samples](../../../samples/client/angular)
...
**See working example:** [React shell](../../../samples/client/react/shell)
...
See [samples/client/lit/shell/client.ts](../../../samples/client/lit/shell/client.ts) for an example of using the A2A protocol client.
...
See `try...catch` blocks in `#sendMessage` in [samples/client/lit/shell/app.ts](../../../samples/client/lit/shell/app.ts) for examples of handling communication errors.
