...
- **Core Library**:
    ...
    For example, see the [JavaScript web core library](../adapters/web_core/README.md).
...
- **Framework adapter**:<a id="fw-adapter"></a>
    ...
    See the [Angular adapter](../adapters/angular/README.md).
...
- **Catalog Implementation**:
    ...
    For example:
    - See the [Angular implementation of the basic catalog](../adapters/angular/src/v0_9/catalog/basic)
