...
3. **Audit Code-vs-Docs Public API and Settings**:
   - Make sure the glossary is respected. Verify that terms used in code, documentation  and blueprints are consistent with [the glossary](../../../docs/public/concepts/glossary.md). If you find deviations, suggest fixes. If you see an important term is used in documentation and/or API, but is missed in glossary, suggest an update for the glossary.
