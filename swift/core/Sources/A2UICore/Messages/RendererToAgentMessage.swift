...
/// Top-level envelope for renderer-to-agent messages (actions or errors).
///
/// Matches `specification/v0_9_1/json/client_to_server.json`
/// and `specification/v1_0/json/renderer_to_agent.json`.
public enum RendererToAgentMessage: Equatable, Codable, Sendable {
  case action(RendererAction)
  case error(RendererToAgentError)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode("v0.9.1", forKey: .version)  // TODO: support version 1.0 encoding if needed
