...
/// agent-to-renderer commands.
///
/// Matches `specification/v0_9_1/json/server_to_client.json` (for older versions)
/// and `specification/v1_0/json/agent_to_renderer.json`.
