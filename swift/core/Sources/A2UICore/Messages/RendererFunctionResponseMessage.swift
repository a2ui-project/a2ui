...
/// Response returned by the renderer for a function invocation requested by the agent.
public struct RendererFunctionResponseMessage: Codable, Sendable, Equatable {
