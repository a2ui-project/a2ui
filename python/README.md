...
curl -s "https://api.github.com/repos/a2ui-project/a2ui/commits?path=python&since=$LAST_RELEASE_TIME"
```

The command will return an empty list if no changes are related to the Python SDKs, otherwise, it returns a list of commits.
