...
class TextComponent(CatalogComponentCommon):
    ...
    variant: Literal["h1", "h2", "h3", "h4", "h5", "caption", "body"] | None = Field(description="A hint for the base text style.", default="body")
...
class CardComponent(CatalogComponentCommon):
    ...
    child: ComponentId = Field(..., description="The ID of the single child component to be rendered inside the card. To display multiple elements, you MUST wrap them in a layout component (like Column or Row) and pass that container's ID here. Do NOT pass multiple IDs or a non-existent ID.")
...
class ModalComponent(CatalogComponentCommon):
    ...
    trigger: ComponentId = Field(..., description="The ID of the component that opens the modal when interacted with (e.g., a button).")
    content: ComponentId = Field(..., description="The ID of the component to be displayed inside the modal.")
...
class ButtonComponent(CatalogComponentCommon):
    ...
    child: ComponentId = Field(..., description="The ID of the child component. Use a 'Text' component for a labeled button. Only use an 'Icon' if the requirements explicitly ask for an icon-only button.")
