...
class CheckRule(StrictBaseModel):
    ...
    message: str = Field(..., description="The error message to display if the check fails.")
...
class ActionEvent(StrictBaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    name: str = Field(..., description="The name of the action to be dispatched to the server.")
