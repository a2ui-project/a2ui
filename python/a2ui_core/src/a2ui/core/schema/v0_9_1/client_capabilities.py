...
class FunctionDefinition(StrictBaseModel):
    ...
    description: str | None = Field(None, description="A human-readable description of what the function does and how to use it.")
    parameters: Any = Field(..., description="A JSON Schema describing the expected arguments (args) for this function.")
    return_type: Literal["string", "number", "boolean", "array", "object", "any", "void"] = Field(..., alias="returnType", description="The type of value this function returns.")
...
class InlineCatalog(BaseModel):
    ...
    components: dict[str, Any] | None = Field(None, description="Definitions for UI components supported by this catalog.")
    functions: list[FunctionDefinition] | None = Field(None, description="Definitions for functions supported by this catalog.")
    theme: dict[str, Any] | None = Field(None, description="A schema that defines a catalog of A2UI theme properties. Each key is a theme property name (e.g. 'primaryColor'), and each value is the JSON schema for that property.")
