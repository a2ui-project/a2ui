...
- **Conformance testing:** Language-agnostic conformance test suites across all Agent and Core SDK implementations (see [agent_sdks/conformance/README.md](agent_sdks/conformance/README.md)).
