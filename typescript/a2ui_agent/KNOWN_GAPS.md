...
- **TypeScript:** The TypeScript decompiler honours `updateDataModel.path` (mapping non-root paths to `$/path` leaf assignments), writes standalone `updateDataModel` surface lines, and quotes non-identifier map keys.
