...
/**
 * Child reference analysis configuration for A2UI v0.8 schemas.
 */
export const V08_CHILD_REF_OPTIONS: ChildRefAnalysisOptions = {
  childRefNames: new Set(['ComponentId', 'Child', 'ChildComponentId']),
  childListRefNames: new Set(['ChildList', 'TemplateChildList']),
};

/**
 * Standard $defs dictionary for A2UI v0.8 catalog JSON schemas.
 */
export const V08_STANDARD_DEFS: Record<string, unknown> = {
  'ComponentId': {
    'description':
