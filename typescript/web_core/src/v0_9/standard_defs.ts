...
/**
 * Child reference analysis configuration for A2UI v0.9 and v0.9.1 schemas.
 */
...
/**
 * Standard $defs dictionary for A2UI v0.9 and v0.9.1 catalog JSON schemas.
 */
export const V09_STANDARD_DEFS: Record<string, unknown> = {
  'ComponentId': {
    'type': 'string',
    'description':
