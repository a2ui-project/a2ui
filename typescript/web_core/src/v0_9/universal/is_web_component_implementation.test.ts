...
describe('isWebComponentImplementation', () => {
  ...
  it('returns false when missing element', () => {
    assert.strictEqual(
      isWebComponentImplementation({
        name: 'test',
        schema: z.object({}),
  ...
  it('returns false when element is not a function', () => {
    assert.strictEqual(
      isWebComponentImplementation({
        tagName: 'a2ui-test',
  ...
  it('returns true when defining tagName and element even if name or schema omitted', () => {
    assert.strictEqual(
      isWebComponentImplementation({
        tagName: 'a2ui-test',
        element: MockElement,
