...
- **In Lit**: `new Catalog('my-catalog', '0.9', [...basicCatalog.components.values(), myBadgeComponent])`
- **In React**: `new Catalog('my-catalog', '0.9', [...basicCatalog.components.values(), myBadgeComponent])`
