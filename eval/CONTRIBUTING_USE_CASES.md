...
- `catalog` (required, string): Relative path to the component catalog. Use `'catalogs/v1_0/basic/catalog.json'` for standard v1.0 components; older versions live at `'specification/{version}/catalogs/basic/catalog.json'`.
