...
- **`catalogs/`**: Canonical `catalog.json` schemas for the catalogs maintained by the A2UI team (e.g. `catalogs/v1_0/basic/`, `catalogs/mcp/`). Catalogs are versioned independently of the protocol.
