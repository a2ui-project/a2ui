...
- **`conformance/`**: Language-agnostic conformance test suites (`suites/`) and JSON schemas (`conformance_schema.json`) for A2UI core client framework behaviors (e.g. `DataModel`).
