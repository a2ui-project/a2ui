...
BASIC_CATALOG_FILE = os.path.join(REPO_ROOT, "catalogs/v1_0/basic/catalog.json")

# Map of schema filenames to their full paths
# Note: catalog.json is dynamically created from catalogs/v1_0/basic/catalog.json
SCHEMAS = {
...
def setup_catalog_alias(catalog_file=None):
    """
    Creates a temporary catalog.json from catalogs/v1_0/basic/catalog.json (or
...
def validate_catalogs_structure():
    ...
    catalogs_to_validate = [
        ("catalogs/v1_0/basic/catalog.json", BASIC_CATALOG_FILE),
