...
2. **Navigate and Execute**:
   ...
   A2UI_EXPRESS_ENABLED=true uv run --project ../../../agent_sdks/python/a2ui_agent scripts/run_inference.py \
     ../../../catalogs/v1_0/basic/examples/01_flight-status.json \
...
```bash
A2UI_EXPRESS_ENABLED=true uv run --project ../../../agent_sdks/python/a2ui_agent scripts/run_prompt_generator.py --catalog ../../../catalogs/v1_0/basic/catalog.json
```
...
```bash
A2UI_EXPRESS_ENABLED=true uv run --project ../../../agent_sdks/python/a2ui_agent scripts/run_decompiler.py ../../../catalogs/v1_0/basic/examples/01_flight-status.json
```
