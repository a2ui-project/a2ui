...
exports.SurfaceUpdateSchemaMatcher = void 0;
 ...
 */
class SurfaceUpdateSchemaMatcher extends schema_matcher_1.SchemaMatcher {
    constructor(componentType, propertyName, propertyValue, caseInsensitive = false) {
        super();
        ...
        if (Array.isArray(actualValue)) {
            for (const item of actualValue) {
                if (typeof item === 'object' && item !== null) {
                    ...
                    if (item.literalString !== undefined &&
                        typeof expectedValue === 'string' &&
                        compareStrings(item.literalString, expectedValue))
                        return true;
                    if (item.literalNumber !== undefined && item.literalNumber === expectedValue)
                        return true;
...
exports.SurfaceUpdateSchemaMatcher = SurfaceUpdateSchemaMatcher;
