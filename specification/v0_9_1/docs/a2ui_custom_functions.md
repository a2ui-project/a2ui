    ...
    "trim": {
      ...
      "properties": {
        ...
        "args": {
          ...
          "properties": {
            "value": {
              "$ref": "https://a2ui.org/specification/v0_9_1/common_types.json#/$defs/DynamicString",
    ...
    "getScreenResolution": {
      ...
      "properties": {
        ...
        "args": {
          ...
          "properties": {
            "screenIndex": {
              "$ref": "https://a2ui.org/specification/v0_9_1/common_types.json#/$defs/DynamicNumber",
  ...
  "$defs": {
    "anyFunction": {
      "oneOf": [
        ...
        {
          "$ref": "https://a2ui.org/specification/v0_9_1/catalogs/basic/catalog.json#/$defs/anyFunction"
        }
      ]
    }
  }
