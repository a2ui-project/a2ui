...
class ResolvedBinding<T> {
  ...
  bool operator ==(Object other) {
    if (other is! ResolvedBinding ||
        (this is WritableBinding) != (other is WritableBinding)) {
      return false;
    }
    if (this is WritableBinding && other is WritableBinding) {
      if ((this as WritableBinding).path != other.path) return false;
    }
  ...
  int get hashCode => Object.hash(
    _valueHash(value),
    this is WritableBinding,
    this is WritableBinding ? (this as WritableBinding).path : null,
  );
}
