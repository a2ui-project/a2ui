...
- (v0_9) Support universal Web Components in the v0.9 renderer:
  ...
  - Update `A2uiRendererService` and `ComponentHostComponent` to dynamically resolve and render either universal Web Components or native Angular components. [#2273](https://github.com/a2ui-project/a2ui/pull/2273)
