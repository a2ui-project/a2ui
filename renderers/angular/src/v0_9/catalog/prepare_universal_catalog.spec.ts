...
describe('prepareUniversalCatalog', () => {
  ...
  it('preserves existing WebComponentImplementation items without changes', () => {
    class MockPrepElement1 extends (typeof HTMLElement !== 'undefined' ? HTMLElement : Object) {}
    class MockPrepElement2 extends (typeof HTMLElement !== 'undefined' ? HTMLElement : Object) {}
    ...
    const catalog = new AngularCatalog('test-existing-wc-catalog', [
      {
        ...
        element: MockPrepElement1 as CustomElementConstructor,
      },
      {
        name: 'ExistingWc2',
        schema: z.object({}),
        tagName: 'existing-wc-2',
        element: MockPrepElement2 as CustomElementConstructor,
      },
    ]);
  ...
  it('reuses pre-built universal tag name directly when available without bridging', () => {
    class MockDualElement extends (typeof HTMLElement !== 'undefined' ? HTMLElement : Object) {}
    const prebuiltWcApi: WebComponentImplementation = {
      name: 'DualItem',
      schema: z.object({}),
      tagName: 'a2ui-prebuilt-dual-item',
      element: MockDualElement as CustomElementConstructor,
    };
  ...
  it('does not re-bridge components that already define a tagName', () => {
    class MockSpecifiedElement extends (typeof HTMLElement !== 'undefined'
      ? HTMLElement
      : Object) {}
    ...
    const customImpl: WebComponentImplementation = {
      ...
      schema: z.object({}),
      tagName: customTag,
      element: MockSpecifiedElement as CustomElementConstructor,
    };
