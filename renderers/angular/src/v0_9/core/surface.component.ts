...
import {BasicCatalogComponent} from '../catalog/types';
...
export class SurfaceComponent implements OnDestroy {
  ...
  surface = input<SurfaceModel<BasicCatalogComponent>>();
  ...
  private getEffectiveSurface(): SurfaceModel<BasicCatalogComponent> | undefined {
    ...
    if (id && this.rendererService) {
      return this.rendererService.surfaceGroup?.getSurface(id) as
        | SurfaceModel<BasicCatalogComponent>
        | undefined;
    }
    return undefined;
  }
