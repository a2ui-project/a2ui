...
- (v0_9) `NodeResolver` reconciles model events delivered after its construction: a deletion whose component exists again refreshes instead of disposing, and nodes rebind when their component's model instance is replaced.
