...
- (v0_9) Add WebComponentImplementation helpers (`isWebComponentImplementation` type guard and `createWebComponentImplementation` helper). [#2596](https://github.com/a2ui-project/a2ui/pull/2596)
