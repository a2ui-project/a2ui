...
/**
 * Defines a catalog inline for the a2uiRendererCapabilities object.
 */
...
/**
 * The capabilities structure sent from the renderer to the agent as part of transport metadata.
 */
export type A2uiRendererCapabilities =
  | {
