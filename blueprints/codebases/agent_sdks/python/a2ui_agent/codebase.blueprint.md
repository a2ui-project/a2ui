...
- **Streaming & Parsing**: Uses regex-based real-time block extraction (`re.DOTALL` tag searches) inside `DirectJsonStreamParser` to isolate JSON segments from LLM streams on the fly.
