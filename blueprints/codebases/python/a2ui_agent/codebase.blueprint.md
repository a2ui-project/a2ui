...
- **Validation**: Structural layout and schema validation are delegated directly to core `a2ui.core.validation.PayloadValidator` to enforce contract compliance across all inference formats.
