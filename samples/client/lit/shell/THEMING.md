...
- **Web Core**: Supplies base design tokens (color palettes, typography, spacing)
  that are used by the A2UI-provided renderers via global CSS custom properties on the root element. See the [Basic Catalog default styles](../../../../renderers/web_core/src/basic_catalog/styles/default.ts).
- **Lit Renderer**: Each Basic Catalog component provided by the Lit renderer
  ...
  expose in the [Lit Basic Catalog Components](../../../../renderers/lit/src/catalogs/basic/components).
