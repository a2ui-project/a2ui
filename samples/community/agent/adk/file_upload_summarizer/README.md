...
- **Multimodal Summarization**: Uses `gemini-3.8-flash` (with zero thinking budget for low latency) to generate concise executive summaries of uploaded documents.
