...
const WebAppFrameSrcdocPropsSchema = z.object({
...
export class WebAppFrameSrcdoc
  extends CatalogComponent<WebAppFrameSrcdocApi>
  implements OnDestroy, OnInit
{
  ...
  private expectedOrigin = window.location.origin;
